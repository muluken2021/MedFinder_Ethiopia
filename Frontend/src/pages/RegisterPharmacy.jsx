...
const RegisterPharmacy = () => {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen py-16 px-4" style={{ backgroundColor: '#F6F8FA' }}>
        <div className="container mx-auto max-w-2xl">
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: 'rgba(43, 182, 115, 0.1)' }}>
              <svg className="w-12 h-12" style={{ color: '#2BB673' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen py-12 px-4" style={{ backgroundColor: '#F6F8FA' }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  {formData.licenseDocument && (
                    <p className="text-sm mt-1" style={{ color: '#2BB673' }}>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-8 sticky top-24">
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-start">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center mr-3 mt-1" style={{ backgroundColor: 'rgba(43, 182, 115, 0.1)' }}>
                    <svg className="w-4 h-4" style={{ color: '#2BB673' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
