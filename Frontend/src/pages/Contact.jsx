...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen py-16 px-6" style={{ backgroundColor: theme.background }}>
      <div className="container mx-auto max-w-7xl">
        {/* Header Section */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight" style={{ color: '#2D2D49' }}>
            Get in <span className="text-blue-600">Touch</span>
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed font-medium">
            Have questions about finding medicine or registering your pharmacy? 
            Our support team is here to help you navigate MedFinder Ethiopia.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-4 rounded-2xl bg-gray-50 border-2 border-transparent outline-none focus:border-blue-600/20 focus:bg-white transition-all font-medium text-gray-900 resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  className="w-full md:w-auto px-10 py-4 rounded-2xl bg-blue-600 text-white font-bold text-lg hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                >
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            {/* Map Integration */}
            <div className="bg-white rounded-[2.5rem] shadow-xl shadow-blue-900/5 overflow-hidden border border-gray-100 p-2">
              ...
              <div className="p-6 flex items-center justify-between">
                ...
                <Globe className="text-blue-100" size={40} />
              </div>
            </div>
...
const ContactInput = ({ label, name, value, onChange, placeholder, type = "text" }) => (
  <div className="space-y-2">
    ...
    <input
      ...
      className="w-full px-5 py-4 rounded-2xl bg-gray-50 border-2 border-transparent outline-none focus:border-blue-600/20 focus:bg-white transition-all font-medium text-gray-900 placeholder:text-gray-400"
    />
  </div>
)
