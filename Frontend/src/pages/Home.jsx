    ...
    <>
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div
            className="absolute top-20 right-10 w-64 h-64 opacity-10 rounded-full blur-3xl"
            style={{ backgroundColor: theme.primary }}
          ></div>
          <div
            className="absolute bottom-20 left-10 w-64 h-64 opacity-10 rounded-full blur-3xl"
            style={{ backgroundColor: theme.primary }}
          ></div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-gray-200 rounded-lg shadow-lg overflow-hidden h-96 relative">
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100">
              ...
              <div
                className="absolute top-20 left-20 w-4 h-4 rounded-full shadow-lg animate-pulse"
                style={{ backgroundColor: theme.primary }}
              ></div>
              <div
                className="absolute top-32 right-32 w-4 h-4 rounded-full shadow-lg animate-pulse"
                style={{ backgroundColor: theme.primary }}
              ></div>
              <div
                className="absolute bottom-24 left-1/3 w-4 h-4 rounded-full shadow-lg animate-pulse"
                style={{ backgroundColor: theme.primary }}
              ></div>
              <div
                className="absolute bottom-32 right-1/4 w-4 h-4 rounded-full shadow-lg animate-pulse"
                style={{ backgroundColor: theme.primary }}
              ></div>
            </div>
          </div>
